...
func (m *MockAutoScalingApi) NewDescribeAutoScalingGroupsPaginator(params *autoscaling.DescribeAutoScalingGroupsInput) domain.DescribeAutoScalingGroupsPager {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewDescribeAutoScalingGroupsPaginator", params)
	ret0, _ := ret[0].(domain.DescribeAutoScalingGroupsPager)
	return ret0
}
...
// NewDescribeAutoScalingGroupsPaginator mocks base method.
func (m *MockDescribeAutoScalingGroupsPaginator) NewDescribeAutoScalingGroupsPaginator(params *autoscaling.DescribeAutoScalingGroupsInput) domain.DescribeAutoScalingGroupsPager {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewDescribeAutoScalingGroupsPaginator", params)
	ret0, _ := ret[0].(domain.DescribeAutoScalingGroupsPager)
	return ret0
